...
# nsame=${bam/%_S[1-12]*_L001_R1_001_val_1.fq.gz/}
...
bwa mem -M -v 3 -t $THREADS /home/ad45368/PedwiniiGenome/GCF_019428685.1_ASM1942868v1_genomic ${trimmed}/*val_1.fq.gz ${trimmed}/*val_2.fq.gz | samtools view -bhSu - | samtools sort -@ $THREADS -T ${bamdir}/${accession}/ -o "$bam" -
samtools index "$bam"
...
macs3 callpeak -t "${bam}" -f BAMPE -n "${accession}"  --outdir "${PeakDir}" --nolambda
